...
export default class LWCLazyloadingDemo  extends NavigationMixin(LightningElement) {
  @api objectApiName;
  @api fieldNamesStr;
  ...
  @wire(initRecords, { ObjectName: 'Account', fieldNamesStr: 'Name,phone,rating', recordId: '' , Orderby: 'Id', OrderDir: 'ASC',inlineEdit:'$inlineEdit' , enableColAction:'$colAction' })
