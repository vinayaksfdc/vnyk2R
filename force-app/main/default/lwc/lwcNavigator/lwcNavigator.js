...
export default class LwcNavigator extends NavigationMixin(LightningElement) {
    ...
    // Navigate to Url and get state using navaigatetolwc aura component
    handleNavigate() {
        this[NavigationMixin.Navigate]({
            type: "standard__component",
            attributes: {
                componentName: "c__targetLwcComponent"
            },
            state: {
